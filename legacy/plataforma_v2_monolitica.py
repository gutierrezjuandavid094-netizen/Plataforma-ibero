# -*- coding: utf-8 -*-
"""ARCHIVO HISTÓRICO: no ejecutar ni usar como base para nuevas mejoras.

La aplicación activa y segura se inicia desde ``Main.py`` y vive en ``src/``.
Este archivo conserva únicamente la referencia de la versión monolítica 2.0.
"""
